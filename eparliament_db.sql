...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2025 at 05:42 PM
...
(1, 'Current software or manual process used (if any):', 'radio', 'Fully Manual\r\nPartially Digital\r\nFully Digital', 1, 1, '', 1, 1);
...
(1, 'Current Workflow', 'to know the current structure', 1, 1, '2025-04-05 09:30:39.258187', '2025-04-05 10:34:09.673215'),
(2, 'Comaprison', '', 2, 1, '2025-04-05 10:36:02.522786', '2025-04-05 10:36:02.522801'),
(3, 'Others', 'test', 3, 1, '2025-04-06 14:25:10.256834', '2025-04-06 14:25:10.256848');
...
--
-- Dumping data for table `requirements_app_questionresponse`
--

INSERT INTO `requirements_app_questionresponse` (`id`, `response_text`, `question_id`, `form_id`) VALUES
(1, 'Fully Manual', 1, 1),
(6, 'Fully Manual', 1, 6);
...
CREATE TABLE `requirements_app_requirementform` (
  ...
  `user_id` bigint(20) NOT NULL,
  `current_process` varchar(20) NOT NULL,
  `digital_software` varchar(100) NOT NULL,
  `attachment` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

--
-- Dumping data for table `requirements_app_requirementform`
--

INSERT INTO `requirements_app_requirementform` (`id`, `process_name`, `status`, `created_at`, `updated_at`, `submitted_at`, `user_id`, `current_process`, `digital_software`, `attachment`) VALUES
(1, 'HR', 'submitted', '2025-04-05 11:09:11.508779', '2025-04-05 11:13:31.539459', '2025-04-05 11:13:31.539394', 3, 'manual', 'N/A', NULL),
(6, 'khj', 'submitted', '2025-04-07 14:55:24.871178', '2025-04-07 14:55:24.871212', '2025-04-07 14:55:24.870933', 4, 'manual', 'hj', 'attachments/110100060.pdf');
...
(1, 'pbkdf2_sha256$870000$jPxkCyQxKzfOikUnxyPIYO$HqmRQ/J452pgomkmSwrFtJ9WCdbsRxLbY3VoWkRcKTU=', '2025-04-06 15:12:26.931243', 1, 'alamin', '', '', 'alamin@gmail.com', 1, 1, '2025-04-05 08:58:10.412461', 'user', '', '', '', '', '', '', ''),
(2, 'pbkdf2_sha256$870000$MABututGmqJhqYn4JUDj5G$BeKSUdePlUbpCfzVkJFu5+qu+YCieu1zRgcsC5rtRpw=', '2025-04-07 15:22:53.137056', 0, '110100091', 'Al-Amin', 'Hossain', '', 0, 1, '2025-04-05 09:01:26.518627', 'admin', 'Programmer', 'B&IT', 'IT', 'Software Development', '01914219285', 'photos/user_None.jpg', 'signatures/user_None.jpg'),
...
(4, 'pbkdf2_sha256$870000$5k1E03ewL3VGR464oWIFeB$q8LFHlmwtIMrKIRgSVXNX0wVl1AiuwidtImRwph3aWw=', '2025-04-07 15:23:13.918047', 0, '110100060', 'Ashif', 'Iqbal', 'learning.fba.amz@gmail.com', 0, 1, '2025-04-07 14:03:52.390435', 'user', 'Director', 'B&IT', 'System Management', 'N/A', '01932382816', 'photos/user_4.jpg', 'signatures/user_4.jpg');
